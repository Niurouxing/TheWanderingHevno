// packages/core-engine/src/TemplateResolver.ts
 ...
 */
export function resolveTemplate(template: any, context: ExecutionContext): any {
 ...
 */
function getValueFromContext(key: string, context: ExecutionContext): any {
