...
export class GraphExecutor {
    ...
    validateGraphConnections(graph) {
        ...
        for (const edge of graph.edges) {
            ...
            if (sourcePort.kind === 'data' && targetPort.kind === 'data') {
                if (!areTypesCompatible(sourcePort.valueType, targetPort.valueType)) {
                    console.warn(`Type mismatch on edge ${edge.id}: ` +
    ...
    async execute(graph, initialInputs) {
...
//# sourceMappingURL=GraphExecutor.js.map