...
class LayoutService {
    public focusPanel(panelId: string) {
        ...
        console.log(`[core_layout] Focusing panel: ${panelId}`);
    }

    public toggleSidebar() {
        services.bus.emit('layout:toggle-sidebar');
        console.log('[core_layout] Toggling sidebar visibility');
    }
}
...
export default definePlugin({
    ...
    onLoad: (context: PluginContext) => {
        ...
        console.log(`[core_layout] Plugin loaded. Priority: ${priority}.`);
    ...
    onActivate: (context: PluginContext) => {
        console.log('[core_layout] Plugin activated.');
